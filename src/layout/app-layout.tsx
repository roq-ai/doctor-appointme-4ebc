...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['system-administrator', 'doctor', 'nurse', 'receptionist'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Billings', path: '/billings', entity: 'billing', service: AccessServiceEnum.PROJECT, icon: FiCreditCard },
    {
    ...
    { name: 'Schedules', path: '/schedules', entity: 'schedule', service: AccessServiceEnum.PROJECT, icon: FiClock },
